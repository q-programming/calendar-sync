                            ...
                            <Stack spacing={3}>
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        <TextField
                                            ...
                                            helperText={
                                                errors.frequencyMinutes?.message ||
                                    ...
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <TextField
                                                ...
                                                helperText={
                                                    errors.daysPast?.message ||
                                                    'History window to sync.'
                                                }
                                                InputProps={{ sx: { fontFamily: 'monospace' } }}
                                            />
                                        )}
                                    ...
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <TextField
                                                ...
                                                helperText={
                                                    errors.daysFuture?.message ||
                                                    'Future window to sync.'
                                                }
                                                InputProps={{ sx: { fontFamily: 'monospace' } }}
                                            />
                                        )}
                                ...
                                >
                                    <Box>
                                        ...
                                        <Typography variant='body2'>
                                            Mirror Outlook category colors to Google Calendar event
                                            colors.
                                        </Typography>
                                    </Box>
                                    <Controller
                                        name='syncColorLabels'
                                        control={control}
                                        render={({ field }) => (
                                            <Switch
                                                checked={field.value}
