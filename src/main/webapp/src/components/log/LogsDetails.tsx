            ...
            <Stack spacing={3} data-testid='log-details-view'>
                <Box>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                        ...
                        <Chip
                            ...
                            color={
                                details.run.status === SyncRunStatus.Success
                                    ? 'success'
                                    : details.run.status === SyncRunStatus.Running
                                      ? 'warning'
                                      : 'error'
                            }
                            size='small'
                    ...
                    <Typography variant='body2' sx={{ mt: 1 }}>
                        Run started{' '}
                        {formatLocal(details.run.startedAt, "MMMM d, yyyy 'at' HH:mm:ss")}
                    </Typography>
                </Box>
                ...
                >
                    {[
                        ...
                        {
                            label: 'Finished',
                            value: details.run.finishedAt
                                ? formatLocal(details.run.finishedAt, 'HH:mm:ss')
                                : '-',
                        },
                    ].map(({ label, value }) => (
                        <Card key={label}>
                ...
                <Card>
                    <CardHeader
                        title={`Log Entries (${details.entries.length})`}
